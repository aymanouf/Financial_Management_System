...
# hashlib.sha256("your_admin_password".encode()).hexdigest()
# hashlib.sha256("your_viewer_password".encode()).hexdigest()
ADMIN_PASSWORD_HASH = "5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8"  # Default: "password"
VIEWER_PASSWORD_HASH = "b133a0c0e9bee3be20163d2ad31d6248db292aa6dcb1ee087a2aa50e0fc75ae2"  # Default: "viewer"
...
def show_login():
    ...
    with st.form("login_form"):
        ...
        if submitted:
            if check_password(password, ADMIN_PASSWORD_HASH):
                ...
                # Use st.rerun() with no indentation issues
                st.rerun()
    ...
    Please enter the appropriate password for your access level.
    """)
...
def main():
    ...
    # Display user role
    st.sidebar.info(f"Logged in as: {st.session_state.user_role.upper()}")
    ...
    if st.session_state.page == 'dashboard':
        ...
        if st.session_state.page == 'transactions':
            ...
            st.info("For security reasons, password changes must be done directly in the source code.")
            st.write("Please contact the system administrator to change passwords.")
